...
#         tagging = Tagging.create! valid_attributes
#         put :update, params: { book_id: book.id, tagging: new_attributes}, session: valid_session
#         tagging.reload
...
#       it "assigns the requested tagging as @tagging" do
#         tagging = Tagging.create! valid_attributes
#         put :update, params: { book_id: book.id, tagging: valid_attributes}, session: valid_session
#         expect(assigns(:tagging)).to eq(tagging)
#       end
...
#       tagging = Tagging.create! valid_attributes
#       expect {
#         delete :destroy, params: { book_id: book.id }, session: valid_session
#       }.to change(Tagging, :count).by(-1)
#     end
